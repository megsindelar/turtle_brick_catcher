...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml','launch/show_turtle.launch.py','launch/run_turtle.launch.py','launch/turtle_arena.launch.py','urdf/turtle.urdf.xacro','config/turtle_urdf.rviz']),
    ],
